...
assemble_output<-function(number_sim, sample_size, Delta_list,Gamma_list,
                          path_scenario_A, path_scenario_B, path_scenario_C, path_scenario_hybrid, path_mean_times_origin,include_scenario_B=FALSE,
  ...
  if (include_scenario_C & include_scenario_hybrid & include_scenario_B){
    combined_data_frame<-do.call("rbind", list(data_frame_A,data_frame_hybrid,  data_frame_B, data_frame_C))
  }  else if (include_scenario_hybrid  & include_scenario_B){
    combined_data_frame<-do.call("rbind", list(data_frame_A, data_frame_hybrid, data_frame_B))
  }else if (include_scenario_C & include_scenario_B){
    combined_data_frame<-do.call("rbind", list(data_frame_A, data_frame_C, data_frame_B))
  }else if (include_scenario_B){
    combined_data_frame<-do.call("rbind", list(data_frame_A, data_frame_B))
  }else {
    combined_data_frame<-do.call("rbind", list(data_frame_A))
  }
...
compareRatioPlot<-function(combined.ratio.data.frameAB, path_to_save, sample_size){
  ...
  ggsave(paste(path_to_save, "/", "CombinedRatioMediansA_Bn=",sample_size, ".png", sep=""))
...
all.data.frame_100<-assemble_output(sim, 100, Delta_list,Gamma_list,
                                       path_scenario_A= paste(path_to_save,"/", "listDataFramesA_100_",nB_100,".rds", sep=""),
                                       path_scenario_B=paste(path_to_save,"/", "listDataFramesB_100_",nB_100,".rds", sep=""),
                                       path_scenario_hybrid=paste(path_to_save,"/", "listDataFramesHybrid_100_",nB_100,".rds", sep=""),
                                       path_scenario_C=paste(path_to_save,"/", "listDataFramesC_100_",nB_100,".rds", sep="") , 
                                       paste(path_to_save,"/", "meansToriginA_100.rds", sep=""),include_scenario_B=TRUE,
                                       include_scenario_C=FALSE, include_scenario_hybrid=FALSE, shifted_scale=FALSE, nB_100 )

ratio.data.frame_100<-get_ratio_data(sim, 100, Delta_list,Gamma_list,
                                        paste(path_to_save,"/", "listDataFramesA_100_",nB_100,".rds", sep=""), 
                                        paste(path_to_save,"/", "listDataFramesB_100_",nB_100,".rds", sep=""))

meanTOriginDataFrame_100<-get_mean_time_origin_data(sim, 100, Delta_list,Gamma_list,
                                                       paste(path_to_save,"/", "meansToriginA_100_",nB_100,".rds", sep=""))

CI_TOriginDataFrame_100<-get_CI_time_origin_data(sim, 100, Delta_list,Gamma_list,paste(path_to_save,"/", "listToriginCI_A_100_",nB_100,".rds", sep=""),
                                                    paste(path_to_save,"/", "meansToriginA_100_",nB_100,".rds", sep=""))

ratio.data.frame_100_Master<-get_ratio_data(sim, 100, Delta_list,Gamma_list,
                                            pathDataFramesA, 
                                            pathDataFramesB
)
...
nB_100=70
all.data.frame_100_70<-assemble_output(sim, 100, Delta_list,Gamma_list,
                                path_scenario_A= paste(path_to_save,"/", "listDataFramesA_100_",nB_100,".rds", sep=""),
                                path_scenario_B=paste(path_to_save,"/", "listDataFramesB_100_",nB_100,".rds", sep=""),
                                path_scenario_hybrid=paste(path_to_save,"/", "listDataFramesHybrid_100_",nB_100,".rds", sep=""),
                                path_scenario_C=paste(path_to_save,"/", "listDataFramesC_100_",nB_100,".rds", sep="") , 
...
ratio.data.frame_100_70<-get_ratio_data(sim, 100, Delta_list,Gamma_list,
                         paste(path_to_save,"/", "listDataFramesA_100_",nB_100,".rds", sep=""), 
                         paste(path_to_save,"/", "listDataFramesB_100_",nB_100,".rds", sep=""))

ratio.data.frame_100_A_Hybrid_70<-get_ratio_data(sim, 100, Delta_list,Gamma_list,
                                     paste(path_to_save,"/", "listDataFramesA_100_",nB_100,".rds", sep=""), 
                                     paste(path_to_save,"/", "listDataFramesHybrid_100_",nB_100,".rds", sep=""))

meanTOriginDataFrame_100_70<-get_mean_time_origin_data(sim, 100, Delta_list,Gamma_list,
                                                paste(path_to_save,"/", "meansToriginA_100_",nB_100,".rds", sep=""))

CI_TOriginDataFrame_100_70<-get_CI_time_origin_data(sim, 100, Delta_list,Gamma_list,paste(path_to_save,"/", "listToriginCI_A_100_",nB_100,".rds", sep=""),
                                                    paste(path_to_save,"/", "meansToriginA_100_",nB_100,".rds", sep=""))
##################################################################
nB_100=50
all.data.frame_100_50<-assemble_output(sim, 100, Delta_list,Gamma_list,
                                    path_scenario_A= paste(path_to_save,"/", "listDataFramesA_100_",nB_100,".rds", sep=""),
                                    path_scenario_B=paste(path_to_save,"/", "listDataFramesB_100_",nB_100,".rds", sep=""),
                                    path_scenario_hybrid=paste(path_to_save,"/", "listDataFramesHybrid_100_",nB_100,".rds", sep=""),
                                    path_scenario_C=paste(path_to_save,"/", "listDataFrameC_100_",nB_100,".rds", sep="") , 
                                    paste(path_to_save,"/", "meansToriginA_100_",nB_100,".rds", sep=""),include_scenario_B=TRUE,
                                    include_scenario_C=FALSE,include_scenario_hybrid=TRUE, shifted_scale=FALSE, nB_100 )

ratio.data.frame_100_50<-get_ratio_data(sim, 100, Delta_list,Gamma_list,
                                     paste(path_to_save,"/", "listDataFramesA_100_",nB_100,".rds", sep=""), 
                                     paste(path_to_save,"/", "listDataFramesB_100_",nB_100,".rds", sep=""))

ratio.data.frame_100_A_Hybrid_50<-get_ratio_data(sim, 100, Delta_list,Gamma_list,
                                              paste(path_to_save,"/", "listDataFramesA_100_",nB_100,".rds", sep=""), 
                                              paste(path_to_save,"/", "listDataFramesHybrid_100_",nB_100,".rds", sep=""))

meanTOriginDataFrame_100_50<-get_mean_time_origin_data(sim, 100, Delta_list,Gamma_list,
                                                    paste(path_to_save,"/", "meansToriginA_100_",nB_100,".rds", sep=""))

CI_TOriginDataFrame_100_50<-get_CI_time_origin_data(sim, 100, Delta_list,Gamma_list,paste(path_to_save,"/", "listToriginCI_A_100_",nB_100,".rds", sep=""),
                                                 paste(path_to_save,"/", "meansToriginA_100_",nB_100,".rds", sep=""))

nB_100=90
all.data.frame_100_90<-assemble_output(sim, 100, Delta_list,Gamma_list,
                                       path_scenario_A= paste(path_to_save,"/", "listDataFramesA_100_",nB_100,".rds", sep=""),
                                       path_scenario_B=paste(path_to_save,"/", "listDataFramesB_100_",nB_100,".rds", sep=""),
                                       path_scenario_hybrid=paste(path_to_save,"/", "listDataFramesHybrid_100_",nB_100,".rds", sep=""),
                                       path_scenario_C=paste(path_to_save,"/", "listDataFrameC_100_",nB_100,".rds", sep="") , 
...
ratio.data.frame_100_90<-get_ratio_data(sim, 100, Delta_list,Gamma_list,
                                        paste(path_to_save,"/", "listDataFramesA_100_",nB_100,".rds", sep=""), 
                                        paste(path_to_save,"/", "listDataFramesB_100_",nB_100,".rds", sep=""))

ratio.data.frame_100_A_Hybrid_90<-get_ratio_data(sim, 100, Delta_list,Gamma_list,
                                                 paste(path_to_save,"/", "listDataFramesA_100_",nB_100,".rds", sep=""), 
                                                 paste(path_to_save,"/", "listDataFramesHybrid_100_",nB_100,".rds", sep=""))

meanTOriginDataFrame_100_90<-get_mean_time_origin_data(sim, 100, Delta_list,Gamma_list,
                                                       paste(path_to_save,"/", "meansToriginA1_100_",nB_100,".rds", sep=""))

CI_TOriginDataFrame_100_90<-get_CI_time_origin_data(sim, 100, Delta_list,Gamma_list,paste(path_to_save,"/", "listToriginCI_A_100_",nB_100,".rds", sep=""),
                                                    paste(path_to_save,"/", "meansToriginA_100_",nB_100,".rds", sep=""))

nB_100=99
all.data.frame_100_99<-assemble_output(sim, 100, Delta_list,Gamma_list,
                                       path_scenario_A= paste(path_to_save,"/", "listDataFramesA_100_",nB_100,".rds", sep=""),
                                       path_scenario_B=paste(path_to_save,"/", "listDataFramesB_100_",nB_100,".rds", sep=""),
                                       path_scenario_hybrid=paste(path_to_save,"/", "listDataFramesHybrid_100_",nB_100,".rds", sep=""),
                                       path_scenario_C=paste(path_to_save,"/", "listDataFrameC_100_",nB_100,".rds", sep="") , 
...
ratio.data.frame_100_99<-get_ratio_data(sim, 100, Delta_list,Gamma_list,
                                        paste(path_to_save,"/", "listDataFramesA_100_",nB_100,".rds", sep=""), 
                                        paste(path_to_save,"/", "listDataFramesB_100_",nB_100,".rds", sep=""))

ratio.data.frame_100_A_Hybrid_99<-get_ratio_data(sim, 100, Delta_list,Gamma_list,
                                                 paste(path_to_save,"/", "listDataFramesA_100_",nB_100,".rds", sep=""), 
                                                 paste(path_to_save,"/", "listDataFramesHybrid_100_",nB_100,".rds", sep=""))

meanTOriginDataFrame_100_99<-get_mean_time_origin_data(sim, 100, Delta_list,Gamma_list,
                                                       paste(path_to_save,"/", "meansToriginA_100_",nB_100,".rds", sep=""))

CI_TOriginDataFrame_100_99<-get_CI_time_origin_data(sim, 100, Delta_list,Gamma_list,paste(path_to_save,"/", "listToriginCI_A_100_",nB_100,".rds", sep=""),
                                                    paste(path_to_save,"/", "meansToriginA_100_",nB_100,".rds", sep=""))


nB_100=25
all.data.frame_100_25<-assemble_output(sim, 100, Delta_list,Gamma_list,
                                       path_scenario_A= paste(path_to_save,"/", "listDataFramesA_100_",nB_100,".rds", sep=""),
                                       path_scenario_B=paste(path_to_save,"/", "listDataFramesB_100_",nB_100,".rds", sep=""),
                                       path_scenario_hybrid=paste(path_to_save,"/", "listDataFramesHybrid_100_",nB_100,".rds", sep=""),
                                       path_scenario_C=paste(path_to_save,"/", "listDataFrameC_100_",nB_100,".rds", sep="") , 
...
ratio.data.frame_100_25<-get_ratio_data(sim, 100, Delta_list,Gamma_list,
                                        paste(path_to_save,"/", "listDataFramesA_100_",nB_100,".rds", sep=""), 
                                        paste(path_to_save,"/", "listDataFramesB_100_",nB_100,".rds", sep=""))

ratio.data.frame_100_A_Hybrid_25<-get_ratio_data(sim, 100, Delta_list,Gamma_list,
                                                 paste(path_to_save,"/", "listDataFramesA_100_",nB_100,".rds", sep=""), 
                                                 paste(path_to_save,"/", "listDataFramesHybrid_100_",nB_100,".rds", sep=""))

meanTOriginDataFrame_100_25<-get_mean_time_origin_data(sim, 100, Delta_list,Gamma_list,
                                                       paste(path_to_save,"/", "meansToriginA_100_",nB_100,".rds", sep=""))

CI_TOriginDataFrame_100_25<-get_CI_time_origin_data(sim, 100, Delta_list,Gamma_list,paste(path_to_save,"/", "listToriginCI_A_100_",nB_100,".rds", sep=""),
                                                    paste(path_to_save,"/", "meansToriginA_100_",nB_100,".rds", sep=""))
...
all.data.frame_10<-assemble_output(sim, 10, Delta_list,Gamma_list,
                                    path_scenario_A= paste(path_to_save,"/", "listDataFramesA_10_",nB_10,".rds", sep=""),
                                    path_scenario_B=paste(path_to_save,"/", "listDataFramesB_10_",nB_10,".rds", sep=""),
                                    path_scenario_hybrid=paste(path_to_save,"/", "listDataFramesHybrid_10_",nB_10,".rds", sep=""),
                                   path_scenario_C=paste(path_to_save,"/", "listDataFramesC_10_",nB_10,".rds", sep=""),  
                                   paste(path_to_save,"/", "meansToriginA_10.rds", sep=""),
                                   include_scenario_B=TRUE,
                                    include_scenario_C=FALSE, include_scenario_hybrid=FALSE, shifted_scale=FALSE, nB_10)

pathDataFramesB_K<-paste(path_to_save,"/","listDataFramesB_",sample.size,"_K=",K, "_", sim,".rds", sep="")
all.data.frame_10_K_2<-assemble_output(sim, 10, Delta_list,Gamma_list,
                                   path_scenario_A= paste(path_to_save,"/", "listDataFramesA_10_",nB_10,".rds", sep=""),
                                   path_scenario_B=paste(path_to_save,"/","listDataFramesB_",sample_size,"_",nB_10,"_K=",K, ".rds", sep=""),
                                   path_scenario_hybrid=paste(path_to_save,"/", "listDataFramesHybrid_10_",nB_10,".rds", sep=""),
                                   path_scenario_C=paste(path_to_save,"/", "listDataFramesC_10_",nB_10,".rds", sep=""),  
                                   paste(path_to_save,"/", "meansToriginA_10.rds", sep=""),
                                   include_scenario_B=TRUE,
...
ratio.data.frame_10<-get_ratio_data(sim, 10, Delta_list,Gamma_list,
                                     paste(path_to_save,"/", "listDataFramesA_10_",nB_10,".rds", sep=""), 
                                     paste(path_to_save,"/", "listDataFramesB_10_",nB_10,".rds", sep=""))

ratio.data.frame_10_Master_M_2<-get_ratio_data(sim, 10, Delta_list,Gamma_list,
                                               pathDataFramesB, 
                                               pathDataFramesB_K
                                    )

ratio.data.frame_10_Master<-get_ratio_data(sim, 10, Delta_list,Gamma_list,
                                           pathDataFramesA, 
                                           pathDataFramesB
                                              )
...
ratio.data.frame_10_Master$Model<-"M_*/A"
ratio.data.frame_10_M_K$Model<-"M_K/A"
ratio.data.frame_10_Master$Sample<-as.factor(10)
ratio.data.frame_10_M_K$Sample<-as.factor(10)

ratio.data.frame_10_Master$x<-10*ratio.data.frame_10_Master$x
...
ratio.data.frame.MAster_M2 <- rbind(ratio.data.frame_10_Master, ratio.data.frame_10_M_K,
                                    ratio.data.frame_100_Master, ratio.data.frame_100_M_K)
require(tidyr)
ratio.data.frame.MAster_M2<-unite(ratio.data.frame.MAster_M2, ModelSample, Model:Sample, sep='', remove=F)

ratio.data.frame_10_A_Hybrid<-get_ratio_data(sim, 10, Delta_list,Gamma_list,
                                              paste(path_to_save,"/", "listDataFramesA_10_",nB_10,".rds", sep=""), 
                                              paste(path_to_save,"/", "listDataFramesHybrid_10_",nB_10,".rds", sep=""))


meanTOriginDataFrame_10<-get_mean_time_origin_data(sim, 10, Delta_list,Gamma_list,
                                                    paste(path_to_save,"/", "meansToriginA_10_",nB_10,".rds", sep=""))

CI_TOriginDataFrame_10<-get_CI_time_origin_data(sim, 10, Delta_list,Gamma_list,paste(path_to_save,"/", "listToriginCI_A_10_",nB_10,".rds", sep=""),
                                                 paste(path_to_save,"/", "meansToriginA_10_",nB_10,".rds", sep=""))
...
sample_size=100
all.data.frame<-all.data.frame_100
meanTOriginDataFrame<-meanTOriginDataFrame_100
CI_TOriginDataFrame<-CI_TOriginDataFrame_100
ratio.data.frameAB<-ratio.data.frame_100
...
for(i in  1:length(K.list)){
  ...
  ratio.data.frameAB<-get_ratio_data(sim, sample.size, Delta_list,Gamma_list,
                                      paste(path_to_save,"/", "listDataFramesA_",sample.size, "_",nB_10,".rds", sep=""), 
                                      fileB)
...
if (varyDelta){
  ...
  tiff(paste(path_to_save, "/",  "RatioMediansScenariosAHybrid50n=",sample_size,"_",90,".tiff", sep=""), units="in", width=3.25, height=3.25, res=300)
  ...
  p5
  ggsave(paste(path_to_save, "/",  "RatioMediansA_Hybrid50n=100.pdf", sep=""))
  ggsave(paste(path_to_save, "/", "RatioMediansA_Hybrid50n=100.png", sep=""))
  ggsave(paste(path_to_save, "/", "RatioMediansA_Hybrid50n=100.jpg", sep=""))
...
= 6))+
  ...
  p5
  ggsave(paste(path_to_save, "/",  "RatioMediansA_Bn=",sample_size, ".pdf", sep=""))
  ggsave(paste(path_to_save, "/", "RatioMediansA_Bn=",sample_size, ".png", sep=""))
  ggsave(paste(path_to_save, "/", "RatioMediansA_Bn=",sample_size, ".jpg", sep=""))
  
  dev.off()
  
  
  tiff(paste(path_to_save, "/",  "RatioMediansM*_M2n=",sample_size,".tiff", sep=""), units="in", width=3.25, height=3.25, res=300)
  
  p5<-ggplot(ratio.data.frame_10_Master_M_2, aes(x = x, y = RatioMedianA1overA2)) +
    geom_point(size=0.5) +
    geom_hline(data = NULL, aes(yintercept = 1))+
    scale_x_continuous(breaks=seq(0,sample_size,  length.out
                                  = 6))+
  ...
  p5
  ggsave(paste(path_to_save, "/",  "RatioMediansM*_M2n=",sample_size, ".pdf", sep=""))
  ggsave(paste(path_to_save, "/", "RatioMediansM*_M2n=",sample_size, ".png", sep=""))
  ggsave(paste(path_to_save, "/", "RatioMediansM*_M2n=",sample_size, ".jpg", sep=""))
  ...
  tiff(paste(path_to_save, "/",  "RatioMediansM*VsM2n=",sample_size,".tiff", sep=""), units="in", width=3.25, height=3.25, res=300)
 
  
  
  p5<-ggplot(ratio.data.frame.MAster_M2, aes(x = x, y = RatioMedianA1overA2, colour=ModelSample)) +
    geom_point(size=0.5) +
    geom_hline(data = NULL, aes(yintercept = 1))+
  ...
  ggsave(paste(path_to_save, "/",  "RatioMediansM*VsM2n=10.pdf", sep=""))
  ggsave(paste(path_to_save, "/", "RatioMediansM*VsM2n=10.png", sep=""))
  ggsave(paste(path_to_save, "/", "RatioMediansM*VsM2n=10.jpg", sep=""))
  ...
  tiff(paste(path_to_save, "/",  "RatioMediansM*VsM2SeveralPlotsn=",sample_size,".tiff", sep=""), units="in", width=5, height=5, res=300)
  cairo_pdf(paste(path_to_save, "/",  "RatioMediansM*VsM2SeveralPlotsn=",sample_size,".pdf", sep=""), p5, width=3, height=3, units="in",dpi = 300)
  Cairo(width = 640, height = 480, file=paste(path_to_save, "/",  "RatioMediansM*VsM2SeveralPlotsn=",sample_size,".pdf", sep=""), type="pdf", pointsize=12,
  ...
  p5<-ggplot(ratio.data.frame.MAster_M2, aes(x = x, y = RatioMedianA1overA2, colour=ModelSample)) +
    ...
    labs(y="", x ="Number of sample ancestors ")+
    theme(plot.margin = unit(c(1,1,2,1), "lines")) +
    facet_rep_wrap(~ interaction(paste0("\u0393=",GammaVar), paste0("n=",Sample)), scales='free', repeat.tick.labels = 'all')+
  ...
  ggsave(paste(path_to_save, "/", "RatioMediansM*VsM2SeveralPlotsn=10.png", sep=""))
  ggsave(paste(path_to_save, "/", "RatioMediansM*VsM2SeveralPlotsn=10.jpg", sep=""))
...
##############################################################################################################################
  ...
  ratio.data.frame.MAster_M2$x[ratio.data.frame.MAster_M2$Sample == 10] <- ratio.data.frame.MAster_M2$x[ratio.data.frame.MAster_M2$Sample == 10] / 10
 
  tiff(paste(path_to_save, "/",  "RatioMediansM*VsM2SeveralPlotsn=",sample_size,".tiff", sep=""), units="in", width=5, height=5, res=300)
  #CairoPDF(paste(path_to_save, "/",  "RatioMediansM*VsM2SeveralPlotsn=",sample_size,".pdf", sep=""), p5, width=5, height=5,res=300 )
 ...
 #       bg = "transparent", canvas = "white", units = "px", dpi = 300)
  ...
  count <- 0
  #tibble_data<-as_tibble(ratio.data.frame.MAster_M2)
  count1 <- 0
  p5<-ggplot(ratio.data.frame.MAster_M2, aes(x = x, y = RatioMedianA1overA2, colour=Model)) +
    geom_point(size=0.5) +
    geom_hline(data = NULL, aes(yintercept = 1))+
    ...
    #coord_capped_cart(bottom='both', left='both', xlim=c(1,99))+
    #facet_grid(paste0(" n=",Sample) ~paste0("\u0393=",GammaVar) )+
    #coord_capped_cart(bottom='both', left='both', xlim=c(1, 100))+
    theme_bw()+theme(panel.border = element_blank(), panel.grid.major = element_blank(),
                     panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+
    theme( legend.position="none")+
  ...
  count <- 0
  count1 <- 0
  ggsave(paste(path_to_save, "/", "RatioMediansM*VsM2SeveralPlotsn=10.png", sep=""),device ="png", units="in", width=5, height=5, dpi=300 )
  #ggsave(paste(path_to_save, "/", "RatioMediansM*VsM2SeveralPlotsn=10.jpg", sep=""))
...
#############################################################################################################################
  ...
  tiff(paste(path_to_save, "/",  "RatioMediansM_Kn=10Vsn=100",".tiff", sep=""), units="in", width=3.25, height=3.25, res=300)
  
  p5<-ggplot(ratio.data.frame_M_K, aes(x = x, y = RatioMedianA1overA2, colour=Sample)) +
    geom_point(size=0.5) +
    geom_hline(data = NULL, aes(yintercept = 1))+
    scale_x_continuous(breaks=c(1,20,40,60,80,100))+
    ylim(min(ratio.data.frame_M_K$RatioMedianA1overA2),min(max(ratio.data.frame_M_K$RatioMedianA1overA2),1.05))+
    labs(y="", x ="Number of sample ancestors ")+
    theme(plot.margin = unit(c(1,1,2,1), "lines")) +
    facet_grid(~ paste0("\u0393=",GammaVar))+
    theme_bw()+theme(panel.border = element_blank(), panel.grid.major = element_blank(),
  ...
  ggsave(paste(path_to_save, "/",  "RatioMediansM_Kn=10Vsn=100.pdf", sep=""))
  ggsave(paste(path_to_save, "/", "RatioMediansM_Kn=10Vsn=100.png", sep=""))
  ggsave(paste(path_to_save, "/", "RatioMediansM_Kn=10Vsn=100.jpg", sep=""))
